...
import pacman.controllers.InClassMCTS;
import pacman.controllers.KeyBoardInput;
import pacman.controllers.MoveRightController;
import pacman.controllers.RightLeftController;
...
//		exec.runGameTimed(new MoveRightController(), new StarterGhosts(), visual);
//		exec.runGameTimed(new RightLeftController(), new StarterGhosts(), visual);
//		exec.runGameTimed(new GameStateFirst(), new StarterGhosts(), visual);
//		exec.runGameTimed(new InClassMCTS(), new StarterGhosts(), visual);
